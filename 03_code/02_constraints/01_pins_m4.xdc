...
# ============================================================================
# 【变更说明】
#   - 移除sys_clk_50m外部时钟（改用PS7 FCLK_CLK0）
#   - 移除sys_rst_n外部复位（改用PS7 FCLK_RESET0_N）
#   - LED/KEY/DDS/ADC/SCAN引脚保持不变
#   - 新增PS7固定引脚（UART/USB/JTAG等由Block Design自动分配）
#   - 添加Bank电压约束（Bank 34使用3.3V）
# ============================================================================

# ============================================================================
# 0. Bank电压约束（必须在引脚约束之前）
# ============================================================================
# Bank 34使用3.3V供电（正点原子领航者板设计）
set_property CONFIG_VOLTAGE 3.3 [current_design]
set_property CFGBVS VCCO [current_design]

# 明确指定Bank 34的VCCO为3.3V
set_property VCCAUX_IO DONTCARE [get_iobanks 34]
