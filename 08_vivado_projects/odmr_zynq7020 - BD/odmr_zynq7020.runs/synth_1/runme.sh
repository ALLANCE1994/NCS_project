...
HD_PWD='C:/Users/YXCOA/Desktop/lxb/NCS_project-main/08_vivado_projects/odmr_zynq7020/odmr_zynq7020.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_odmr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_odmr.tcl
